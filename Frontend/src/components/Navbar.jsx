        ...
        <div className="navbar">
          ...
          <div className="navbar-end space-x-3">
            <div className="navbar-center hidden lg:flex">
              <ul className="menu menu-horizontal px-1">{naveItems}</ul>
            </div>
            <div className="hidden md:block">
              <label className="px-1 py-1 border rounded-md flex items-center gap-1">
                <input
                  type="text"
                  className="grow outline-none text-sm w-20"
                  placeholder="Search"
                />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
